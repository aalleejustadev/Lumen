...
- `components/marketing/` — the marketing site (`site-header.tsx`, sections, footer).
...
`ui-design/{light,dark}/**` holds the rendered design system, exported at 2x —
divide pixel measurements by 2 for CSS values. Match these when building.
