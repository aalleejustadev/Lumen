...
- `components/marketing/` — the marketing site (`site-header.tsx`, `hero-section.tsx`, sections, footer). Sections own their own backdrop; page-level files just stack sections.
